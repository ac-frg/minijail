...
int API minijail_run_pid_pipe_no_preload(struct minijail *j,
                                         const char *filename,
                                         char *const argv[], pid_t *pchild_pid,
                                         int *pstdin_fd) {
  return minijail_run_internal(j, filename, argv, pchild_pid, pstdin_fd, NULL,
                               NULL, false);
}
