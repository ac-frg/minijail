...
/*
 * Helper function used by --add-supp-group (possibly more than once),
...
static void usage(const char *progn)
{
	...
	printf("Usage: %s [-dGhHiIKlLnNprRstUvyYz]\n"
	       ...
	       "                Not compatible with -y or --add-supp-group.\n"
	       "  -y:           Keep original uid's supplementary groups.\n"
	       "                Not compatible with -G or --add-supp-group.\n"
	       "  --add-supp-group <g>:Add <g> to the proccess' supplementary groups,\n"
	       ...
	       const char **preload_path)
{
	...
	const struct option long_options[] = {
		...
		{"add-supp-group", required_argument, 0, 135},
		{0, 0, 0, 0},
	};
	/* clang-format on */
