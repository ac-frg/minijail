...
TEST_F(ArgFilterTest, arg0_short_lt) {
  const char *fragment = "arg1 < 0xff";
...
TEST_F(ArgFilterTest, arg0_short_ge) {
  const char *fragment = "arg1 >= 0xff";
...
#if defined(BITS64)
TEST_F(ArgFilterTest, arg0_ge) {
  const char *fragment = "arg1 >= 0xbadc0ffee0ddf00d";
