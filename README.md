...
on libchrome (the chromeos packaged version of chromium //base). Some
archaeology turned up evidence of this:
https://crrev.com/6c1d8a49c7231ebc9a42913eb490aefca3541ed1 deleted the
incomplete old C++ implementation, and crbug/204988 tracked the work of deleting
it. I probably named the smaller one minijail0 because of its small-ness, but
also so its name wouldn't collide with the deprecated one.

IIRC, we didn't want to call it minijail2 or something that would make people
...
controlled surprise system call use.  I think we initially planned to have the
bigger minijail call the minijail0 behind the scenes, but that started looking
silly almost right away!  Maybe I'm remembering wrong though.

http://crrev.com/c/4585/ added the original implementation.

(edited excerpts from email from Elly and Will)
