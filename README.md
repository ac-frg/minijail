...
on libchrome (the chromeos packaged version of chromium //base).  also so its
name wouldn't collide with the deprecated one.
...
silly almost right away!

http://crrev.com/c/4585/ added the original implementation.

Source: Conversations with original authors, Elly & Will.
