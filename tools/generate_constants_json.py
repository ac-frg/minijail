...
ParseResults = typing.NamedTuple('ParseResults',
                                 [('table_name', str),
                                  ('table_entries', typing.Mapping[str, str])])


def parse_llvm_ir(ir: typing.TextIO) -> ParseResults:
    """Parses a single LLVM IR file."""
    string_constants: typing.OrderedDict[str, str] = collections.OrderedDict()
    table_entries: typing.OrderedDict[str, str] = collections.OrderedDict()
    table_name = ''
    for line in ir:
...
def main(argv: typing.Sequence[str]) -> int:
    ...
    constants_json: typing.Dict[str, typing.Any] = {}
