...
ParseResults = typing.NamedTuple(
    'ParseResults',
    [('table_name', str),
     ('table_entries', typing.Mapping[str, typing.Union[int, str]])])


def parse_llvm_ir(ir: typing.TextIO) -> ParseResults:
    """Parses a single LLVM IR file."""
    string_constants = collections.OrderedDict()  # type: typing.Dict[str, str]
    table_entries = collections.OrderedDict()  # type: typing.Dict[str, int]
    table_name = ''
    for line in ir:
...
def main(argv: typing.Sequence[str]) -> int:
    ...
    constants_json = {}  # type: typing.Dict[str, typing.Any]
