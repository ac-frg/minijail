...
LLVM_IR_INSTRS = """Generate LLVM IR: clang -S -emit-llvm libconstants.gen.c libsyscalls.gen.c
"""
...
def main(argv=None):
    ...
    parser = argparse.ArgumentParser(description=__doc__, epilog=LLVM_IR_INSTRS)
