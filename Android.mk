...
LOCAL_GENERATED_SOURCES/$(TARGET_ARCH) += $(generated_sources_dir)/libsyscalls.c
...
$(generated_sources_dir)/$(TARGET_2ND_ARCH)/libsyscalls.c: PRIVATE_CUSTOM_TOOL = $< "$(lastword $(CLANG)) \
...
$(generated_sources_dir)/$(TARGET_2ND_ARCH)/libconstants.c: PRIVATE_CUSTOM_TOOL = $< "$(lastword $(CLANG)) \
	$($(TARGET_2ND_ARCH_VAR_PREFIX)RS_TRIPLE_CFLAGS) -isystem bionic/libc/kernel/uapi/asm-$(TARGET_2ND_ARCH)" $@
