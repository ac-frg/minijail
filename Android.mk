...
$(generated_sources_dir)/libsyscalls.c: PRIVATE_CUSTOM_TOOL = $< "$(lastword $(CLANG)) \
	$($(TARGET_2ND_ARCH_VAR_PREFIX)RS_TRIPLE_CFLAGS) -isystem bionic/libc/kernel/uapi/asm-$(TARGET_ARCH)" $@
...
$(generated_sources_dir)_$(TARGET_2ND_ARCH)/libsyscalls.c: PRIVATE_CUSTOM_TOOL = $< "$(lastword $(CLANG)) \
	$($(TARGET_2ND_ARCH_VAR_PREFIX)RS_TRIPLE_CFLAGS) -isystem bionic/libc/kernel/uapi/asm-$(TARGET_2ND_ARCH)" $@
$(generated_sources_dir)_$(TARGET_2ND_ARCH)/libsyscalls.c: $(LOCAL_PATH)/gen_syscalls.sh
	$(transform-generated-source)
LOCAL_GENERATED_SOURCES_$(TARGET_2ND_ARCH) += $(generated_sources_dir)/libsyscalls.c

$(generated_sources_dir)_$(TARGET_2ND_ARCH)/libconstants.c: PRIVATE_CUSTOM_TOOL = $< "$(lastword $(CLANG)) \
	$($(TARGET_2ND_ARCH_VAR_PREFIX)RS_TRIPLE_CFLAGS) -isystem bionic/libc/kernel/uapi/asm-$(TARGET_2ND_ARCH)" $@
$(generated_sources_dir)_$(TARGET_2ND_ARCH)/libconstants.c: $(LOCAL_PATH)/gen_constants.sh
	$(transform-generated-source)
LOCAL_GENERATED_SOURCES_$(TARGET_2ND_ARCH) += $(generated_sources_dir)_$(TARGET_2ND_ARCH)/libconstants.c
endif
